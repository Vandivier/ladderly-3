    ...
    <LadderlyPageWrapper title="Privacy Policy">
      <LargeCard>
        ...
        <p>
          ...
          users interact with ladderly.io site. Such information may include the browser you are
          using and which pages you have visited.
        </p>
        ...
        <p>
          ...
          and to customize your user experience. If you make a purchase in the ladderly.io store, we
          collect data to ensure proper delivery and for tax accounting reasons.
        </p>
        ...
        <p>
          A valid email address is required to create an account. You can also add more information
          about yourself in your user profile, though this is entirely optional.
        </p>

        <h2 className="mb-3 mt-5 text-xl">Can any other organizations access my data?</h2>
        <p>
          We do not sell your data, though we do utilize some third party tools. For example,
          ladderly.io utilizes{" "}
          <a
        ...
        <h2 className="mb-3 mt-5 text-xl">I have questions about my privacy on Ladderly</h2>
        <p>
          We{`'`}re here to help. Reach out at{" "}
          <a href="mailto:admin@ladderly.io">admin@ladderly.io</a>.
        </p>

        <h2 className="mb-3 mt-5 text-xl">How can I find out about changes?</h2>
        <p>
          This version of the ladderly.io privacy Q&A was last updated on 9/30/2023. Keep an eye on
          your emails for any future updates or changes.
        </p>
      </LargeCard>
    </LadderlyPageWrapper>
  )
