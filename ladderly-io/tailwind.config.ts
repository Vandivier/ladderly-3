  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        'text-link-fancy-gradient':
          'linear-gradient(to right, rgb(99,1,235), rgb(124,58,237), rgb(231,216,246))',
      },
      boxShadow: {
      ...
      colors: {
        'ladderly-violet-700': 'rgb(102, 34, 170)',
        'ladderly-violet-100':
          'color-mix(in srgb, var(--ladderly-violet-700) 5%, white)',
        'ladderly-light-purple-1':
          'color-mix(in srgb, var(--ladderly-violet-700) 5%, white)',
        'ladderly-off-white':
          'color-mix(in srgb, var(--ladderly-violet-700) 5%, white)',
