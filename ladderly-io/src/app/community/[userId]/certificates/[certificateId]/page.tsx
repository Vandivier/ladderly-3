    ...
    return (
      <LadderlyPageWrapper>
        <div className="mx-auto max-w-4xl px-4">
          <div className="relative overflow-hidden rounded-lg border-8 border-blue-600 bg-white p-8 shadow-xl dark:bg-gray-800">
            {/* Certificate Header */}
            <div className="mb-8 text-center">
              <div className="mb-4 flex justify-center">
                <Image
                  src="/images/ladderly-logo.png"
                  alt="Ladderly Logo"
                  width={120}
                  height={120}
                />
            ...
            <div className="flex flex-col items-center justify-between space-y-4 text-center sm:flex-row sm:space-y-0 sm:text-left">
              ...
              <div className="flex flex-col items-center">
                <div className="h-12 w-40 border-b-2 border-gray-700 dark:border-gray-300">
            ...
            <div className="mt-8 rounded-lg bg-gray-50 p-4 dark:bg-gray-700">
              ...
              <p className="mb-4 text-sm text-gray-600 dark:text-gray-400">
                Add this certificate to your LinkedIn profile or share it on
                social media.
              </p>
              <div className="flex flex-wrap gap-2">
                <a
                  href={`https://www.linkedin.com/profile/add?startTask=CERTIFICATION_NAME&name=${encodeURIComponent(courseName)}&organizationName=Ladderly&issueYear=${new Date(certificate.createdAt).getFullYear()}&issueMonth=${new Date(certificate.createdAt).getMonth() + 1}&certUrl=https://ladderly.io/community/${userId}/certificates/${certificateId}`}
                  target="_blank"
