  ...
  return (
    <LadderlyPageWrapper>
      <div className="container mx-auto max-w-6xl px-4 py-2">
        <h1 className="mb-2 text-3xl font-bold">Community Journal Feed</h1>
        <p className="mb-6 text-gray-600 dark:text-gray-400">
          Public career journal entries shared by the Ladderly community. Get
          inspired, share, and grow your network!
        </p>
