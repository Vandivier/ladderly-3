...
export const UpdateUserSettingsSchema = z.object({
  ...
  profileHighestDegree: z.string().optional(),
  profileHomepageUri: z.string().nullable(),
  profileLinkedInUri: z.string().nullable(),
  profileTopNetworkingReasons: z.array(z.string()).optional(),
  profileTopSkills: z.array(z.string()).optional(),
  profileYearsOfExperience: z.number().optional(),
