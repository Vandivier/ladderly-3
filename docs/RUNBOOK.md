...
Cleaning also currently removes the LeetCode Problems Checklist. I'm not sure why. So, you might want to `npm run seed:update-in-place` AFTER `db:clean` for now.
